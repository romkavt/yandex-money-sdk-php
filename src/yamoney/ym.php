...
interface IYandexMoney {
     ...
     * к аккаунту пользователя и затем сервер Яндекс.Денег сделает редирект на
...
/**
 * Класс-перечисление прав приложения на использование аккаунта Яндекс.Денег
 * пользователя.
 */
class YMScope {
    ...
    /**
     * Функция возвращает массив возможных прав для досутупа к аккаунту
