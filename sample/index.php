...
/**
 * To use test mode you have to get token and put it to TOKEN constant in RoutesTest.php file
 * Than, enable test mode and launch tests in RoutesTests.php
 */
//$currentMode = TEST_MODE;

/**
 * You can use app mode to get token and make some api requests
 */
